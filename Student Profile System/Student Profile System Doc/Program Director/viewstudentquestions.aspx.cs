...
public partial class Program_Director_viewstudentquestions : System.Web.UI.Page
{
    ...
    protected void lnkView_Click(object sender, EventArgs e)
    {
        ...
        {
            Panel1.Visible = false;
            ClientScript.RegisterStartupScript(Page.GetType(), "validation", "<script language='javascript'>alert('There is no data')</script>");
        }
    }
